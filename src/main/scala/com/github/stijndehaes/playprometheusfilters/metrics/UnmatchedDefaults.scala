...
/**
 * Defines default value what to return in case a certain property cannot be retrieved. This allows for customization
 * per metric what to return in case a value does not exist.
 *
 * E.g. instead of returning a 'unmatchedVerbe' string, could get the actual verbe from a
 ...
 *
 * @tparam T
 *   Request object type for web framework. E.g. for play it's the [[play.api.mvc.RequestHeader]].
 */
